...
export const COMMANDS: CommandEntry[] = [
  ...
  // ── Core Workflow ────────────────────────────────────────────────────────────
  {
    ...
    usage: "effect:dev:plan docs/prds/001-my-feature.md",
  },
  {
    name: "effect:dev:tdd",
    phase: "Core Workflow",
  ...
  {
    name: "effect:dev:run (alias: /ralph-loop)",
    phase: "Autonomous",
    icon: "Bot",
    ...
    deprecated: true,
    deprecatedNote: "/ralph-loop is a permanent alias for effect:dev:run — it will never be removed.",
  },
  {
    ...
    usage: "effect:dev:stop",
  },
  {
    name: "effect:dev:stop (alias: /cancel-ralph)",
    phase: "Autonomous",
    icon: "OctagonX",
    ...
    usage: "effect:dev:stop",
    deprecated: true,
    deprecatedNote: "/cancel-ralph remains as a permanent alias for effect:dev:stop.",
  },
  {
    ...
    usage: "effect:dev:save",
  },
  {
    name: "effect:dev:save (alias: /checkpoint)",
    phase: "Autonomous",
    icon: "Bookmark",
  ...
  },
  {
    ...
    usage: "/effectum:init",
    deprecated: true,
    deprecatedNote: "Use effectum:init instead. Removed in v0.20.",
  },
  {
    name: "/workshop:init",
    phase: "Project",
  ...
  // ── Setup ─────────────────────────────────────────────────────────────────────
  {
    ...
    usage: "effectum:setup ~/my-project",
  },
];
